    ...
    'x-api-key': 'APP_API_KEY'
            ...
            <li>
              <article>
                ...
                <section className="mt-2 ml-7">
                  <p className="flex items-baseline">
                    <span className="inline-block px-2 py-1 bg-blue-100 text-blue-800 text-xs font-mono rounded mr-2">POST</span>
                    <code className="text-sm font-mono">/api/files/</code>
                  </p>
                  <p className="mt-2 text-gray-600">Retrieve a specific user's constitutional documents with metadata with their email in body of request.</p>
                </section>
              </article>
            </li>
          </ul>
